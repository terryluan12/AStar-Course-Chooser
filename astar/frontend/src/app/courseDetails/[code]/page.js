...
class CourseDescriptionPage extends Component {
  ...
  componentDidMount() {
    console.log("pass in course code: ", this.props.params.code)
    console.log("pass in course code: ", this.code)

    axios.get(`${process.env.NEXT_PUBLIC_API_URL}/course/details?code=${this.props.params.code}`, {
      ...
      .then(res => {
        ...
        let syllabus_link = "http://courses.skule.ca/course/" + this.props.params.code
    ...
    if(this.state.username){
      ...
      .then(res => {
        ...
        for (let i = 0; i < len; i++) {
          ...
          console.log("course: ", this.props.params.code)
          if (res.data.wishlist.course[i].code === this.props.params.code) {
            star = starred
